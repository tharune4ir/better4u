...
export default function InnerPresentationPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0c0a09] relative overflow-hidden">
      ...
      <div className="absolute bottom-[15%] right-[-10%] w-[40vw] h-[40vw] bg-amber-800/8 rounded-full blur-[140px] pointer-events-none" />
      ...
      <main className="flex-1 w-full max-w-3xl mx-auto px-4 sm:px-6 py-12 pb-24 z-10 relative space-y-16">
        ...
        >
          <span className="text-[10px] tracking-widest text-amber-600 font-bold uppercase bg-amber-900/15 border border-amber-800/15 px-3.5 py-1 rounded-full inline-flex items-center gap-1.5 mb-4">
            <Sparkles className="w-3.5 h-3.5" />
            Executive Narrative
          </span>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extralight text-stone-100 tracking-tight leading-tight">
            The Blueprint & <span className="font-semibold text-stone-50">Future Vision</span>
          </h1>
          <p className="text-xs sm:text-sm text-stone-500 font-light mt-3 max-w-xl mx-auto leading-relaxed">
        ...
        <motion.section
          ...
          className="rounded-3xl p-6 sm:p-8 border border-amber-900/15 bg-stone-900/40 backdrop-blur-md"
        >
          <div className="flex items-center gap-3 mb-6">
            <div className="w-9 h-9 rounded-xl bg-amber-900/20 border border-amber-800/20 flex items-center justify-center">
              <User className="w-4 h-4 text-amber-500" />
            </div>
            <div>
              <span className="text-[8px] font-bold text-amber-600 uppercase tracking-widest block">Chapter 01</span>
              <h2 className="text-lg font-semibold text-stone-100">Who I Am & Capability Proof</h2>
            </div>
          </div>
          ...
          <div className="space-y-4 text-xs text-stone-400 font-light leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-stone-800/30">
              <div className="bg-stone-950/40 p-4 rounded-2xl border border-stone-850">
                <span className="text-[9px] font-bold text-amber-600 uppercase tracking-widest block mb-1">Web Dev & Systems</span>
                <p className="text-[10px] text-stone-500">React, Next.js architecture, state synchronization, dynamic design protocols.</p>
              </div>
              <div className="bg-stone-950/40 p-4 rounded-2xl border border-stone-850">
                <span className="text-[9px] font-bold text-amber-600 uppercase tracking-widest block mb-1">Physical Execution</span>
                <p className="text-[10px] text-stone-500">Formulating prebiotics, constructing fitness regimens, daily habit automation.</p>
              </div>
            </div>
          </div>
        </motion.section>
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: "-50px" }}
          transition={{ duration: 0.7 }}
          className="rounded-3xl p-6 sm:p-8 border border-amber-900/15 bg-stone-900/40 backdrop-blur-md relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-900/5 rounded-full blur-2xl pointer-events-none" />
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <span className="text-[8px] font-bold text-amber-600 uppercase tracking-widest block">Chapter 02</span>
              <h2 className="text-lg font-semibold text-stone-100">The "Doctor-Lag" Thesis</h2>
            </div>
          </div>

          <div className="space-y-4 text-xs text-stone-400 font-light leading-relaxed">
            <p className="text-sm font-light text-stone-200 italic border-l-2 border-amber-600/40 pl-4 py-1">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <span className="text-[8px] font-bold text-amber-600 uppercase tracking-widest block">Chapter 03</span>
              <h2 className="text-lg font-semibold text-stone-100">The 8-Month Infinite Health Blueprint</h2>
            </div>
          </div>

          <div className="space-y-6 text-xs text-stone-400 font-light leading-relaxed">
            <p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                <span className="text-xs font-bold text-amber-500 bg-amber-900/10 border border-amber-800/10 w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0">01</span>
                <div>
                  <h4 className="text-xs font-semibold text-stone-200">The Food Wing (Prebiotic Engine)</h4>
              ...
              <div className="flex gap-4">
                <span className="text-xs font-bold text-amber-500 bg-amber-900/10 border border-amber-800/10 w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0">02</span>
                <div>
                  <h4 className="text-xs font-semibold text-stone-200">The Movement Wing (Durable Chassis)</h4>
                  <p className="text-[10px] text-stone-500 mt-1">
              ...
              <div className="flex gap-4">
                <span className="text-xs font-bold text-amber-500 bg-amber-900/10 border border-amber-800/10 w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0">03</span>
                <div>
                  <h4 className="text-xs font-semibold text-stone-200">The Thinking Wing (Cognitive Buffer)</h4>
                  <p className="text-[10px] text-stone-500 mt-1">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <span className="text-[8px] font-bold text-amber-600 uppercase tracking-widest block">Chapter 04</span>
              <h2 className="text-lg font-semibold text-stone-100">The Brand Plan: Bottling the Future</h2>
            </div>
          </div>
          ...
          <div className="space-y-4 text-xs text-stone-400 font-light leading-relaxed">
            ...
            <div className="bg-stone-950/40 p-4 rounded-2xl border border-stone-850 mt-4">
              <span className="text-[9px] font-bold text-stone-400 uppercase tracking-widest block mb-2">Roadmap Target Milestones</span>
              <div className="space-y-2">
                <div className="flex justify-between items-center text-[10px] text-stone-500 border-b border-stone-800/20 pb-1.5">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <span className="text-[8px] font-bold text-amber-600 uppercase tracking-widest block">Chapter 05</span>
              <h2 className="text-lg font-semibold text-stone-100">Runway & Financial Ask</h2>
            </div>
          </div>

          <div className="space-y-5 text-xs text-stone-400 font-light leading-relaxed">
            <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-stone-950/40 p-4 rounded-2xl border border-stone-850 text-center">
                <span className="text-[8px] font-bold text-stone-500 uppercase tracking-widest block mb-1">Horizon</span>
                <span className="text-sm font-semibold text-stone-100">8 Months</span>
              </div>
              <div className="bg-stone-950/40 p-4 rounded-2xl border border-stone-850 text-center">
                <span className="text-[8px] font-bold text-stone-500 uppercase tracking-widest block mb-1">Weekly Cap</span>
                <span className="text-sm font-semibold text-amber-500">Strict limit</span>
              </div>
              <div className="bg-stone-950/40 p-4 rounded-2xl border border-stone-850 text-center">
                <span className="text-[8px] font-bold text-stone-500 uppercase tracking-widest block mb-1">Administration</span>
                <span className="text-sm font-semibold text-stone-100">Clean Entity</span>
              </div>
            </div>

            <div className="bg-stone-950/45 p-4 rounded-2xl border border-stone-850 space-y-3">
              <span className="text-[9px] font-bold text-stone-400 uppercase tracking-widest block">The Ask Details</span>
