  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F7F6F2] relative overflow-hidden select-none font-sans text-slate-800">
      ...
      <header className="fixed top-0 w-full h-20 border-b border-black/[0.02] bg-[#F7F6F2]/75 backdrop-blur-md flex items-center justify-between px-6 md:px-12 z-30 select-none">
        ...
        {/* Navigation Action + Time Status */}
        <div className="flex items-center gap-5 sm:gap-6">
          {/* TOP FOOD WING LINK (Requested) */}
          <button 
            onClick={() => router.push("/food")}
            className="px-4 py-2 bg-[#2A7F7F] text-white hover:bg-[#1e5c5c] rounded-full text-xs font-semibold tracking-wider uppercase transition-all flex items-center gap-1.5 cursor-pointer shadow-sm shadow-[#2A7F7F]/20 hover:shadow-md"
          >
            <span>Food Wing</span>
          ...
          <div className="hidden sm:block w-1.5 h-1.5 rounded-full bg-[#2A7F7F] animate-pulse shadow-sm shadow-[#2A7F7F]/50" />
        </div>
      </header>
      ...
      {/* ==================== ACT 5: THE VISION (CLEAN BRANDING - NO VAULT LINK) ==================== */}
